namespace Weave.Base
{
    public class CRC
    {
        ...
        /// CRCTAB 表
        /// </summary>
        private static readonly ushort[] crctab = new ushort[256]{
        ...
        {
            ushort t1 = (ushort)(crc >> 8);
            ushort t2 = (ushort)(t1 & 0xff);
            ushort t3 = (ushort)(cp & 0xff);
            ushort t4 = (ushort)(crc << 8);
            ushort t5 = (ushort)(t2 ^ t3);
            ushort t6 = (ushort)(crctab[t5] ^ t4);
            return t6;
        }
