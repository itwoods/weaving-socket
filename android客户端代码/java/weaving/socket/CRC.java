...
public class CRC {
    ...
    private static short Xcrc(short crc, byte cp)
    {
        short t1 = (short)(crc >> 8);
        short t2 = (short)(t1 & 0xff);
        short t3 = (short)(cp & 0xff);
        short t4 = (short)(crc << 8);
        short t5 = (short)(t2 ^ t3);
        short t6 = (short)(crctab[t5] ^ t4);
        return t6;
    }
    ...
    public static byte[] ConCRC( byte[] bufin, int n)
    {
        short crc16 = 0;
        int i;
        //n个数据的CRC校验
